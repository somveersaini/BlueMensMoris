...
public class Board {
    ...
    public int getX(int posIndex){
        return boardPositions[posIndex].getPosx();
    }
    public int getY(int posIndex){
        return boardPositions[posIndex].getPosy();
    }
    ...
    public void setPosXY(int squareStart, int squareStartY){
        // outer square
        int a = squareStart;
        int b = squareStartY;
        int s0 = a;
        ...
        Log.d("boardset sx  xy   ", a +  " " + b);

        boardPositions[0].setPosxy(s0, s0 + b);
        boardPositions[1].setPosxy(s0, s3 + b);
        boardPositions[2].setPosxy(s0, s6 + b);
        boardPositions[3].setPosxy(s1,s1 + b);
        boardPositions[4].setPosxy(s1,s3 + b);
        boardPositions[5].setPosxy(s1,s5 + b);
        boardPositions[6].setPosxy(s2, s2 + b);
        boardPositions[7].setPosxy(s2,s3 + b);
        boardPositions[8].setPosxy(s2, s4 + b);

        boardPositions[9].setPosxy(s3, s0 + b);
        boardPositions[10].setPosxy(s3, s1 + b);
        boardPositions[11].setPosxy(s3,s2 + b);
        boardPositions[12].setPosxy(s3, s4 + b);
        boardPositions[13].setPosxy(s3,s5 + b);
        boardPositions[14].setPosxy(s3, s6 + b);

        boardPositions[15].setPosxy(s4,s2 + b);
        boardPositions[16].setPosxy(s4,s3 + b);
        boardPositions[17].setPosxy(s4,s4 + b);
        boardPositions[18].setPosxy(s5,s1 + b);
        boardPositions[19].setPosxy(s5,s3 + b);
        boardPositions[20].setPosxy(s5,s5 + b);
        boardPositions[21].setPosxy(s6,s0 + b);
        boardPositions[22].setPosxy(s6,s3 + b);
        boardPositions[23].setPosxy(s6,s6 + b);
    }
